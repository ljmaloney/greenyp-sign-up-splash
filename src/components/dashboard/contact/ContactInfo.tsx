      ...
      <div className="space-y-2 text-sm">
        <div className="flex items-start">
          <div className="flex items-center gap-2 min-w-[80px]">
            <Phone className="h-4 w-4 flex-shrink-0 text-greenyp-600" />
        ...
        {contact.cellPhoneNumber && (
          <div className="flex items-start">
            <div className="flex items-center gap-2 min-w-[80px]">
              <Phone className="h-4 w-4 flex-shrink-0 text-greenyp-600" />
              <span className="text-gray-600 font-semibold">Cell:</span>
            </div>
        ...
        <div className="flex items-start">
          <div className="flex items-center gap-2 min-w-[80px]">
            <Mail className="h-4 w-4 flex-shrink-0 text-greenyp-600" />
