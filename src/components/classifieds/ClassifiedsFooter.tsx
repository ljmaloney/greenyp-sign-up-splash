      ...
      <div className="container mx-auto px-4 text-center">
        <div className="flex items-center justify-center mb-3">
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
            className="mr-2 h-6 w-6 text-greenyp-400"
          >
          ...
          <span className="text-lg font-bold text-white">GreenYP</span>
        </div>
        <p className="mb-4 text-gray-400 text-sm">Explore the green marketplace, your source for all your lawn and garden needs</p>
        
        <div className="text-xs text-gray-500">
          © {currentYear} GreenYP. All rights reserved. | <a href="#" className="hover:text-white transition-colors">Contact Us</a>
        </div>
      </div>
    </footer>
  );
...
export default ClassifiedsFooter;
