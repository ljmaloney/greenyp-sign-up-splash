...
export const useDashboardPaymentUpdate = ({ producerId, onSuccess, onError }: UseDashboardPaymentUpdateProps) => {
  ...
  const processDashboardPaymentUpdate = useCallback(async (
    card: any,
    payments: any,
